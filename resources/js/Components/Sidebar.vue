    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="" target="#">
        <img
          ...
          alt="main_logo"
        />
        <span class="ms-1 font-weight-bold">Enjoy</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <Link
            ...
            class="nav-link"
            :class="route().current('admin.usuarios.*') ? 'active' : ' '"
          >
            <div
              class="
                icon icon-shape icon-sm
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="servicos" style="">
            <ul class="nav ms-4">
              <li class="nav-item">
                <Link
                  :href="route('admin.servicos-categoria.index')"
                  class="nav-link"
                  :class="
                    route().current('admin.servicos-categoria.*')
                      ? 'active'
                      : ' '
                  "
                >
              ...
              <li class="nav-item">
                <Link
                  ...
                  class="nav-link"
                  :class="
                    route().current('admin.subcategorias.*') ? 'active' : ' '
                  "
                >
                  <span class="sidenav-mini-icon"> S </span>
                  <span class="sidenav-normal"> SubCategorias </span>
                </Link>
              </li>
