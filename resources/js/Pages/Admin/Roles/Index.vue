                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr v-for="(role, index) in roles.data" :key="index">
                      ...
                      <td>
                        <div class="px-4 py-1 d-flex flex-column">
                          <span
...
export default {
  ...
  data() {
    return {
      ...
      permissionsOptions: this.permissions,
      filter: "",
      editMode: false,
  ...
  computed: {
    formTitle() {
      return this.editMode === false ? "Adicionar Perfil" : "Editar Perfil";
    },
    buttonTxt() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.form.delete(this.route("admin.roles.destroy", role), {
            preserveScroll: true,
            onSuccess: () => {
              Swal.fire("Deletado!", "Perfil deletada", "success");
            },
          });
        }
      });
