        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                        <tr v-for="(lojista, index) in lojistas.data" :key="index">
                      <td>
                        <div class="px-4 py-1">
                          <div class="justify-content-center">
                            <h6 class="mb-0 text-sm">{{ lojista.id }}</h6>
                      ...
                      <td>
                        <div class="px-4 py-1">
                          <div class="justify-content-center">
                            <h6 class="mb-0 text-sm">{{ lojista.name }}</h6>
                        ...
                        <div class="px-4 py-1">
                          <div class="justify-content-center">
                            <h6 class="mb-0 text-sm">{{ lojista.email }}</h6>
                      ...
                      <td class="align-middle">
                        <a
                          ...
                          data-toggle="tooltip"
                          data-original-title="Edit lojista"
                          @click.prevent="edit(lojista)"
                        >
                          Editar </a
                        ><!-- |
                        <a
            ...
            <div class="card-footer">
              <pagination :links="lojistas.links"></pagination>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      form: this.$inertia.form({
        ...
        password: null,
        checkPassword: null,
        uuid: this.servico.uuid,
      }),
    };
  },
  computed: {
    formTitle() {
      return this.editMode === false ? "Adicionar Lojista" : "Editar Lojista";
    },
    buttonTxt() {
  ...
  methods: {
    ...
    create() {
      this.form.post(this.route("admin.servico.lojistas.store"), {
        preserveScroll: true,
        onSuccess: () => {
          this.closeModal();
          this.form.reset();
    ...
    edit(lojista) {
      this.openModal();
      this.editMode = true;
      this.form = Object.assign(this.form, lojista);
    },

    update() {
      this.form.patch(
        this.route("admin.servico.lojistas.update", this.form.id, this.form),
        {
          preserveScroll: true,
          onSuccess: () => {
            this.closeModal();
    ...
    deleteModal(pref) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.form.delete(this.route("admin.servicos.destroy", pref), {
            preserveScroll: true,
            onSuccess: () => {
